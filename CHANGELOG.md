...
## [Unreleased](https://git.d3data.de/D3Private/Ordermanager/compare/6.3.0.0...rel_6.x)

## [6.3.0.0](https://git.d3data.de/D3Private/Ordermanager/compare/6.2.1.0...6.3.0.0) - 2026-06-26
### Added
- make installable in OXID 7.5
- CLI calls via oe-console
- event execution state to prevent multiple recursive handlings
- example tasks to documentation
- deal with unsent mail
- invoice number filter additional to bill number
### Changed
- documentation format
- remark contains PDF docs paths
- remark notes completed
### Fixed
- missing mail recipients
- losing remark handler
### Removed
- usage of the D3 DI container

## [6.2.1.0](https://git.d3data.de/D3Private/Ordermanager/compare/6.2.0.0...6.2.1.0) - 2026-02-10
### Added
- automated CI tests
### Fixed
- optional stats request failed
...
- prevent showing TinyMCE WYSIWYG editor on plain input field
- order field requirement can check for not set content
- log cron request

### Changed
- order field requirement check query content is field type dependent
- make input fields ready for WYSIWYG editor

## [6.0.1.0](https://git.d3data.de/D3Private/Ordermanager/compare/6.0.0.0...6.0.1.0) - 2024-09-03
### Added
