        ...
        <dd style="margin-left: 30%;">
            [{if $oView->isEditMode()}]
                [{block name="ordermanager_admin_action_sendmail_editor"}]
                    ...
                    <label for="FromSourceTpl">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTEMPLATE"}]</label>
                    <br>
                    <label style="margin-left: 15px;" for="FromTplSubject">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMSUBJECT"}]</label><input id="FromTplSubject" type="text" name="value[sSendMailFromSubject]" size="50" maxlength="250" value="[{$edit->getValue('sSendMailFromSubject')}]" [{$blActionRestriction}] [{$readonly}]><br>
                    <label style="margin-left: 15px;" for="FromTplHtml">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTEMPLATE_HTML"}]</label><input id="FromTplHtml" type="text" name="value[sSendMailFromTemplatename]" size="50" maxlength="250" value="[{$edit->getValue('sSendMailFromTemplatename')}]" [{$blActionRestriction}] [{$readonly}]> [{oxinputhelp ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTEMPLATE_DESC"}]<br>
                    <label style="margin-left: 15px;" for="FromTplPlain">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTEMPLATE_PLAIN"}]</label><input id="FromTplPlain" type="text" name="value[sSendMailFromTemplatenamePlain]" size="50" maxlength="250" value="[{$edit->getValue('sSendMailFromTemplatenamePlain')}]" [{$blActionRestriction}] [{$readonly}]> [{oxinputhelp ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTEMPLATE_DESC"}]<br>
                    <input style="margin-left: 20px;" id="FromThemeAdmin" type="radio" name="value[sSendMailFromTheme]" value="admin" [{if $edit->getValue('sSendMailFromTheme') == 'admin'}]checked[{/if}] [{$blActionRestriction}] [{$readonly}]> <label for="FromThemeAdmin">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTPL_ADMIN"}]</label><br>
                    <input style="margin-left: 20px;" id="FromThemeFrontend" type="radio" name="value[sSendMailFromTheme]" value="frontend" [{if $edit->getValue('sSendMailFromTheme') == 'frontend'}]checked[{/if}] [{$blActionRestriction}] [{$readonly}]> <label for="FromThemeFrontend">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTPL_FRONTEND"}]</label> [{oxinputhelp ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTPL_DESC"}]<br>
                    <hr>
                    ...
                    <br>
                    <label style="margin-left: 15px;">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMCMS_SUBJECT"}]</label><br>
                    <label for="FromCmsHtml" style="margin-left: 15px;">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMCMS_HTML"}]</label>
                    ...
                    <label for="FromCmsPlain" style="margin-left: 15px;">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMCMS_PLAIN"}]</label>
                    ...
                    <input id="UseStorno" class="edittext ext_edittext" type="checkbox" name="value[blGetStornoArticles]" value='1' [{if $edit->getValue('blGetStornoArticles') == 1}]checked[{/if}] [{$blActionRestriction}] [{$readonly}]>
                    <label for="UseStorno">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_USESTORNOARTICLES"}]</label>
                    [{oxinputhelp ident="D3_ORDERMANAGER_ACTION_MAILSEND_USESTORNOARTICLES_DESC"}]<br>

                    <label for="ReplyAdr">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_USEALTREPLYADR"}]</label>
            ...
            [{else}]
                [{block name="ordermanager_admin_action_sendmail_viewer"}]
                    ...
                    [{if $edit->getValue('sSendMailFromSource') == 'template'}]
                        ...
                        <br>
                        [{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMSUBJECT"}] [{$edit->getValue('sSendMailFromSubject')}]<br>
                        [{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTEMPLATE_HTML"}] [{$edit->getValue('sSendMailFromTemplatename')}] [{oxinputhelp ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTEMPLATE_DESC"}]<br>
                        [{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTEMPLATE_PLAIN"}] [{$edit->getValue('sSendMailFromTemplatenamePlain')}] [{oxinputhelp ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTEMPLATE_DESC"}]<br>
                        [{if $edit->getValue('sSendMailFromTheme') == 'admin'}]
                            [{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTPL_ADMIN"}]
                        [{elseif $edit->getValue('sSendMailFromTheme') == 'frontend'}]
                            [{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTPL_FRONTEND"}]
                        [{/if}]
                    [{elseif $edit->getValue('sSendMailFromSource') == 'cms'}]
                        [{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMCMS"}]
                        <br>
                        [{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMCMS_SUBJECT"}]<br>
                    ...
                    [{if $edit->getValue('sSendMailReplyAddress')}]
                        ...
                        [{oxinputhelp ident="D3_ORDERMANAGER_ACTION_MAILSEND_USEALTREPLYADR_DESC"}]<br>
                    [{/if}]
                [{/block}]
            [{/if}]
