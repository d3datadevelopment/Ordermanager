...
[{* ordermanager *}]
  ...
  <li><a [{if !$firstitem}]class="firstitem"[{assign var="firstitem" value="1"}][{/if}] id="btn.new" href="#" onClick="parent.list.document.search.oxid.value='-1'; parent.list.document.search.submit();document.location='[{$oViewConf->getSelfLink()}]&cl=d3_cfg_ordermanageritem_main';return false" target="edit">[{oxmultilang ident="D3_TOOLTIPS_NEWORDERMANAGER"}]</a> |</li>
  [{/if}]
