<dl class="[{$blActionRestriction}]">
    ...
    <dd style="margin-left: 30%;">
        [{if $oView->isEditMode()}]
            ...
            <input style="margin-left: 20px;" id="FromThemeAdmin" type="radio" name="value[sSendMailFromTheme]" value="admin" [{if $edit->getValue('sSendMailFromTheme') == 'admin'}]checked[{/if}] [{$blActionRestriction}] [{$readonly}]> <label for="FromThemeAdmin">[{oxmultilang ident="D3_ORDERMANAGER_ACTION_MAILSEND_FROMTPL_ADMIN"}] ([{$oView->getManagerTemplateDirs(1)}])</label><br>
