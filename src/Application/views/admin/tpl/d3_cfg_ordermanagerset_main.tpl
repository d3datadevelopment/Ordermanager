            ...
            <td style="vertical-align: top;" class="edittext">
                ...
                <div class="groupExp">
                    <div class="">
                        <a class="rc" onclick="_groupExp(this); return false;" href="#">
                            <b>
                                [{oxmultilang ident="D3_ORDERMANAGER_SET_JOBSETTINGS"}]
                            </b>
                        </a>
                        <dl>
                            <dt>
                                <label for="SetCronActive">[{oxmultilang ident="D3_ORDERMANAGER_SET_CALCULATESTATONDEMAND"}]</label>
                            </dt>
                            <dd>
                                ...
                                [{oxinputhelp ident="D3_ORDERMANAGER_SET_CALCULATESTATONDEMAND_DESC"}]
                            </dd>
                            <div class="spacer"></div>
                        </dl>
                        <dl>
                            <dt>
                                <label for="SetFolder">[{oxmultilang ident="D3_ORDERMANAGER_SET_FOLDERLIST"}]</label>
                            </dt>
                            <dd>
                                ...
                                [{oxinputhelp ident="D3_ORDERMANAGER_SET_FOLDERLIST_DESC"}]
                            </dd>
                            <div class="spacer"></div>
                        </dl>
                    </div>
                ...
                <div class="groupExp">
                    <div class="">
                        <a class="rc" onclick="_groupExp(this); return false;" href="#">
                            <b>
                                [{oxmultilang ident="D3_ORDERMANAGER_SET_CRON"}]
                            </b>
                        </a>
                        <dl>
                            <dt>
                                <label for="SetCronActive">[{oxmultilang ident="D3_ORDERMANAGER_SET_CRON_ACTIVE"}]</label>
                            </dt>
                            <dd>
                                ...
                                [{oxinputhelp ident="D3_ORDERMANAGER_SET_CRON_ACTIVE_DESC"}]
                            </dd>
                            <div class="spacer"></div>
                        </dl>
                        <dl>
                            <dt>
                                <label for="SetCronMaxOrderCnt">[{oxmultilang ident="D3_ORDERMANAGER_SET_CRON_MAXORDERCNT"}]</label>
                            </dt>
                            <dd>
                                <input type="hidden" name="value[iMaxOrderCnt]" value="0">
                                <input id="SetCronMaxOrderCnt" class="edittext ext_edittext" type="text" size="4" maxlength="7" name="value[iMaxOrderCnt]" value="[{if $edit->getValue('iMaxOrderCnt')}][{$edit->getValue('iMaxOrderCnt') == 1}][{else}]50[{/if}]" [{$readonly}]>
                                [{oxinputhelp ident="D3_ORDERMANAGER_SET_CRON_MAXORDERCNT_DESC"}]
                            </dd>
                            <div class="spacer"></div>
                        </dl>
                        <dl>
                            <dt>
                                <label for="SetCronPW">[{oxmultilang ident="D3_ORDERMANAGER_SET_CRON_PASSWORD"}]</label>
                            </dt>
                            <dd>
                                <input id="SetCronPW" class="edittext ext_edittext" type="test" size="20" maxlength="50" name="value[sCronPassword]" value="[{if $edit->getValue('sCronPassword')}][{$edit->getValue('sCronPassword')}][{else}][{$oView->getBaseCronPW()}][{/if}]" [{$readonly}]>
                                [{oxinputhelp ident="D3_ORDERMANAGER_SET_CRON_PASSWORD_DESC"}]
                            </dd>
                            <div class="spacer"></div>
                        </dl>
                    </div>
                        ...
                        <div class="">
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    [{oxinputhelp ident="D3_ORDERMANAGER_SET_CRON_EXTLINK_DESC"}]
                                </dd>
                                <div class="spacer"></div>
                            </dl>
                            <dl>
