                    ...
                    <div class="">
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <input id="SetCronMaxOrderCnt" class="edittext ext_edittext" type="text" size="4" maxlength="7" name="value[iMaxOrderCnt]" value="[{if $edit->getValue('iMaxOrderCnt')}][{$edit->getValue('iMaxOrderCnt') == 1}][{else}]50[{/if}]">
