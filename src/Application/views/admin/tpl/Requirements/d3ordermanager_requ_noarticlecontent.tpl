<dl class="[{$blActionRestriction}]">
    ...
    <dd>
        ...
        [{if $oView->isEditMode()}]
            ...
            <input class="editinput" type="text" size="30" maxlength="100" name="value[sNoArticleContent[{$oRequ->getSlotId()}]RegExp]" value="[{$edit->getValue($sRegExpVarName)}]" [{$blActionRestriction}] [{$readonly}]>
        [{else}]
            <label for="RequNoArticleContent[{$oRequ->getSlotId()}]Type">[{oxmultilang ident="D3_ORDERMANAGER_REQU_ARTICLECONTENT2"}]</label>
