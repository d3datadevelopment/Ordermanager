...
return [
    ...
    'D3_ORDERMANAGER_SET_DEBUG_DESC'                     => 'Mit aktiviertem Test-Modus werden die einzelnen Aufgaben nur am Bildschirm angezeigt und (unabhängig der Aufgabeneinstellung) nicht tatsächlich ausgeführt. Rufen Sie zur Kontrolle den Cronjob einfach über den Command Line Aufruf auf und kontrollieren Sie die Ausgaben.',
    ...
    'D3_GENERAL_ORDERMANAGER_TASKCOUNT_CRONID'           => 'Anzahl aktiver Aufgaben für Cronjob-ID %1$s: %2$u',
    ...
    'D3_ORDERMANAGER_MAIN_FIELDSET_AFTERORDERCOMPLETED'  => 'nach dem Abschluss der Bestellung durch den Kunden (ab Standard-Lizenz)',
    'D3_ORDERMANAGER_MAIN_FIELDSET_AFTERORDERSAVE'       => 'nach jedem Speichern der Bestellung (ab Standard-Lizenz)',
    'D3_ORDERMANAGER_MAIN_FIELDSET_EVENTTRIGGER'         => 'programmierbarer Auslöser (ab Premium Lizenz)',
    ...
    'D3_ORDERMANAGER_MAIN_EVENTID'                       => 'Ereignis-Name',
    'D3_ORDERMANAGER_MAIN_EVENTID_DESC'                  => 'Programmierbaren Auslösern muss der Name des Ereignisses mitgegeben werden. Anhand dieses Namens werden alle zugeordneten Aufgaben gefunden. Erhalten mehrere Aufgaben den gleichen Namen, werden diese beim Start des Ereignisses nacheinander ausgeführt.',
    ...
    'D3_ORDERMANAGER_MAIN_EXECEVENTTRIGGERED'            => 'Ausführung durch jeden programmierten Auslöser des Ereignisses möglich',
    'D3_ORDERMANAGER_MAIN_EXECEVENTTRIGGERED_DESC'       => 'Ist dieser Haken gesetzt, wird diese Aufgabe ausgeführt, wenn das "CustomEvent" mit dem hier eingestellen Ereignisname über den Symfony Event Dispatcher getriggert wird. Details entnehmen Sie bitte dem Handbuch unter https://docs.oxidmodule.com/.',
    ...
    'D3_ORDERMANAGER_REQU_MAILREGEXP_DESC'               => 'Tragen Sie das Suchmuster für die Mailadresse ein. Dabei sind folgende Wildcards erlaubt: [ _ ] ein einzelnes Zeichen, auch leer - [ % ] beliebig viele Zeichen - Um die genannten Zeichen als Suchbegriff zu verwenden, maskieren Sie diese mit einem Schrägstrich [ / ]. - Beispiele: "%@gmx.example" findet alle Adressen der Domain gmx.example - "abc@rtl_.example" findet die Adresse von rtl.example und auch von rtl2.example - Die Groß-/Kleinschreibung ist hierbei egal.',
    ...
    'D3_ORDERMANAGER_CRON_STAT_TASK'                     => 'Aufgabe',
    'D3_ORDERMANAGER_CRON_STAT_LASTEXECTIME'             => 'letzte Ausführungszeit',
    'D3_ORDERMANAGER_CRON_STAT_NOT_YET_EXECUTED'         => 'noch nicht gestartet',
    'D3_ORDERMANAGER_CRON_STAT_ORDERSFROM'               => 'Bestellungen aus %1$s',
    'D3_ORDERMANAGER_CRON_STAT_CHANGES'                  => 'Veränderung',
    'D3_ORDERMANAGER_CRON_STAT_CHANGES_NEW'              => 'neu',
    'D3_ORDERMANAGER_CRON_STAT_ID'                       => 'interne Id',

    'SHOP_MODULE_GROUP_d3_ordermanager_general'          => 'allgemeine Einstellungen',
    'SHOP_MODULE_d3_ordermanager_setting_keptlogfiles'   => 'Anzahl zu speichernder Logdateien',
    'HELP_SHOP_MODULE_d3_ordermanager_setting_keptlogfiles'    => 'Es wird für jeden Tag mit Logvorkommen eine neue Datei angelegt. Ältere Dateien werden automatisch gelöscht.',
    'SHOP_MODULE_d3_ordermanager_setting_logErrorsOnly'  => 'Logeinträge werden nur im Fehlerfall geschrieben',
];
