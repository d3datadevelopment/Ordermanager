...
!!! info "Pfad im Adminbereich"
    [ (D3) Module ] -> [ Auftragsmanager ] -> [ Aufgaben ] -> [ Aktionen ]
...
Welche Aktionen Ihnen zur Verfügung stehen, hängt von der eingesetzten Modul-Edition ab. Eine Übersicht dazu finden Sie im Kapitel [Editionen](../../../editionen.md).
...
Diese Aktion steht in der [Premium-Edition](../../../editionen.md) zur Verfügung.
...
Bei der Verwendung der POST-Übertragungsmethode werden optionale GET-Parameter der URL automatisch an den schon bestehenden Nachrichtenbody angefügt.
